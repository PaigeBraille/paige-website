  ...
  return (
    <div className="bg-white flex justify-between items-end py-6 md:py-12">
      <h1 className="text-lg sm:text-xl md:text-3xl tracking-tight leading-tight md:w-2/3 font-extralight">
        ...
        understand the difficulties blind and partially sighted face when
...
const MissionSection = () => {
  return (
    <div className="pb-6">
      <h2 className="text-2xl font-bold px-4 md:px-6 py-4 bg-primary text-white text-bold rounded-t-lg tracking-tight leading-tight">
        Our mission
      </h2>
      <MissionItem
