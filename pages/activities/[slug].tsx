    ...
    <div>
      {selectedValues.includes('1') && (
        <div className="text-xs inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-auto my-2">
          ...
          <p className="">Communication - develop social communication skills. </p>
        </div>
      )}
      ...
      {selectedValues.includes('3') && (
        <div className="text-xs inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-auto my-2">
          ...
          <p className="">Information - access, produce and manage information independently.</p>
        </div>
      )}
      {selectedValues.includes('4') && (
        <div className="text-xs inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-auto my-2">
          <Technology title="Technology" className="w-4 h-4 mr-2" />
          <p className="">Technology - using technology with as much independence as possible. </p>
        </div>
      )}
    </div>
  );
