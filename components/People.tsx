...
export default function People() {
  return (
    <section className="bg-white py-8 mx-auto text-center lg:py-12">
      <div className="pb-0">
        <Heading css="text-2xl text-start font-bold px-4 md:px-6 py-4 bg-paigedarkblue text-white text-bold rounded-t-lg tracking-tight leading-tight">
          Meet our team
        </Heading>
      </div>
      ...
      <div className="flex flex-col border border-paigedarkgrey rounded-b-lg ">
        <p className="md:w-2/3 flex p-2 md:p-6 text-lg text-left font-light">
