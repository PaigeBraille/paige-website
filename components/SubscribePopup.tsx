export default function SubscribePopup(props: {onDismiss: () => void}) {
  return (
    <div className="fixed top-0 bottom-0 w-screen backdrop-blur" onClick={props.onDismiss}>
      <div className="relative w-screen p-4 md:p-8">
        ...
        >
          ...
          />
          <button className="bg-primary text-white font-medium rounded-sm py-1 px-4 text-sm hover:bg-blue-400">
            Subscribe
          </button>
        </form>
      </div>
