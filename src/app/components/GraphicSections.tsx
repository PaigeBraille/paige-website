      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between w-full text-white bg-primary sm:rounded-lg">
          <div className="inline-flex flex-col gap-4 max-w-lg p-4 sm:p-12 ">
            ...
            <Link
              className="rounded-sm px-4 py-2 font-bold text-primary bg-white hover:bg-blue-100 focus:outline-none focus:shadow-outline text-center sm:mt-12 sm:w-2/3"
              to="/about"
            >
              Learn more
            </Link>
      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between w-full bg-paigelightgreen sm:rounded-lg">
          ...
          <div className="inline-flex flex-col gap-4 max-w-xl sm:text-start p-4 sm:p-12 ">
            ...
            <Link
              className="rounded-sm px-4 py-2 font-bold text-white bg-green-900 hover:bg-green-800 focus:outline-none focus:shadow-outline text-center sm:mt-12 sm:w-2/3"
              to="/resources"
            >
              Learn more
            </Link>
