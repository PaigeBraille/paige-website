...
const GRAPHIC_SECTIONS: GraphicSectionProps[] = [
  {
    graphic: (
      <Graphic
        className="overflow-visible inline-flex h-64 xl:absolute xl:-right-14 xl:-bottom-6 xl:h-96"
      />
    ),
    heading: "Meet Paige",
  ...
  },
  {
    graphic: (
      <Graphic2
        className="overflow-visible inline-flex h-64 xl:absolute xl:-right-6 xl:-bottom-14 xl:h-96"
      />
    ),
  ...
  return (
    <section className="flex flex-col bg-white gap-4 w-full">
      <div className="flex flex-col gap-6">
        <div
          className={`flex flex-col lg:flex-row items-center justify-between w-full xl:rounded-lg xl:overflow-visible relative gap-4 xl:gap-0 px-4 py-8 xl:max-h-80  ${
            props.colorScheme === "BLUE"
              ? "bg-primary text-white "
              : "bg-paigelightgreen"
          }`}
        >
          <div className="inline-flex flex-col xl:max-w-1/2 gap-4 sm:mr-0 xl:mr-96 relative sm:px-4 xl:px-6 xl:py-16">
            <Heading
